...
public class Main {
    public static void main(String[] args) {
        ...
        SimulationParameters simulationParameters = new SimulationParameters(5, 5, 5, 0, 0, SimulationParameters.MutationVariant.RANDOM, SimulationParameters.MapVariant.STANDARD,2, 2, 1, 5);
